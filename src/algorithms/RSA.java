...
public class RSA {
	...
	/*
	 * Enum from cipher mode - its just a wrapper for Cipher.ENCRYPT_MODE and
	 * Cipher_DECRYPT_MODE
	 */
	public enum Mode {
	...
	/*
	 * Method that really executes the encrypt or decrypt operation based on the
	 * mode argument Will return null if exception occur
	 */
